...
class ParameterFactory():
    ...
    advanced_parameters: list[tuple[str, type, Any]] = [
        ('log_level', LogLevel, LogLevel.off),  # BASIC
        ('o_c', bool, False),
        ...
        ('scheduler', Scheduler, Scheduler['es.bsc.compss.scheduler.lookahead.locality.LocalityTS']),
        # ('jvm_workers', str), ##?
        # ('cpu_affinity', str), ##?
        # ('gpu_affinity', str),
        # ('fpga_affinity', str),
        ...
        ('checkpoint_policy', CheckpointPolicy, CheckpointPolicy['es.bsc.compss.checkpoint.policies.NoCheckpoint']),
